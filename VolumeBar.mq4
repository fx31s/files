...
double eq=Low[shift1]+((High[shift1]-Low[shift1])/2);
...
ObjectCreate(ChartID(),"RecUp",OBJ_RECTANGLE,0,Time[shift1-1],High[shift1-1],Time[shift1-1]+100*PeriodSeconds(),Low[shift1-1]);
