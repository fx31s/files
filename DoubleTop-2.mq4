...
/*
   ...
   up_close=true;
      ...
      ObjectCreate(ChartID(),"RUPNEW"+i,OBJ_RECTANGLE,0,top_time[i],h_prices[i],top_time[i]+10*PeriodSeconds(),up_prices[i]);  
...
/*
   ...
   down_close=true;
      ...
      ObjectCreate(ChartID(),"RDOWNEW"+i,OBJ_RECTANGLE,0,top_times[i],l_prices[i],top_times[i]+10*PeriodSeconds(),down_prices[i]);  
